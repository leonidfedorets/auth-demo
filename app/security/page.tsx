...
const MEASURES = [
  ...
  { icon: FileText, title: "Vulnerability disclosure", body: "We operate a responsible disclosure programme. Report security vulnerabilities via our security contact. We aim to acknowledge within 24 hours and patch within 72 hours for critical severity." },
];
export default function SecurityPage() {
  return (<div className="min-h-screen bg-zinc-950 text-white">
    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="mb-12"><div className="text-xs text-zinc-500 uppercase tracking-widest mb-2">Trust · UTH</div><h1 className="text-4xl font-black text-white mb-3">Security at UTH</h1><p className="text-zinc-400 text-lg">Authentication infrastructure that protects your users and your business.</p></div>
      ...
      <div className="rounded-xl border border-indigo-500/30 bg-indigo-600/10 p-6 text-center"><h3 className="font-semibold text-white mb-1">Report a vulnerability</h3><p className="text-zinc-400 text-sm mb-3">Contact our security team to report vulnerabilities responsibly.</p><p className="text-zinc-500 text-xs">We do not pursue legal action against researchers acting in good faith</p></div>
    </div>
    <footer className="border-t border-white/8 px-6 py-6 text-center text-zinc-700 text-xs"><Link href="/" className="hover:text-zinc-400">← Back to UTH</Link></footer>
  </div>);
}
